...
const defaultErrorExactLength = (exactLength) => `only supports an exact length of ${exactLength} characters`;
exports.defaultErrorExactLength = defaultErrorExactLength;
...
const expressionDigitsOnlyValidator = (value) => exports.EXPRESSION_REGULAR_ONLY_NUMBERS.test(value);
